...
def newaudio_predict(new_img_path):
    ...
    loaded_model = keras.models.load_model("Recognition\\datasets\\model\\cnn_model.h5")
...
def channel_process(new_img_save):
    ...
    save_path = "Recognition\\datasets\\predict\\new_img.png"
...
def newaudio_process(new_audio_path):
    ...
    new_img_save = "Recognition\\datasets\\predict\\new_img.png"
